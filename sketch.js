...
function setup() {
  ...
  border1 = new Border(300,4,600,7);
  border2 = new Border(597,400,7,810);
  border3 = new Border(300,796,600,7);
  border4 = new Border(3,400,7,810);

   for(var d=0; d<=width; d=d+80){
    divisions.push(new Division(d, height-divisionHeight/2, 10, divisionHeight));
  }
  
  leftDivision = new Division(10, 650, 10, 300);
  rightDivision = new Division(597, 650, 10, 300);
  ...
  for(var pl=100; pl<=width-10; pl=pl+50){
